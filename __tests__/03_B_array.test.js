...
describe('About Arrays', () => {
  ...
  it('should filter array', () => {
    ...
    var result = array.filter(function(el){return typeof el === 'string' });
...
//fruits = ['1', '2', '3', '4']
// Zo haal je een item uit je array
//const newFruits = [...newFruits.slice(0, fruitIndex), ...newFruits.slice(fruitIndex + 1)]